...
export default defineConfig({
  ...
  server: {
    headers: {
      ...
      'Content-Security-Policy': "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://challenges.cloudflare.com https://www.googletagmanager.com https://www.google-analytics.com https://cdn.withpersona.com https://static.cloudflareinsights.com https://studio.plasmic.app https://*.plasmic.app https://js.stripe.com https://widget.intercom.io https://js.intercomcdn.com; frame-src https://challenges.cloudflare.com https://www.googletagmanager.com https://withpersona.com https://docs.plasmic.app https://studio.plasmic.app https://js.stripe.com; worker-src 'self' https://challenges.cloudflare.com blob:; child-src 'self' https://challenges.cloudflare.com; connect-src 'self' http://localhost:* ws://localhost:* wss://localhost:* https://backend-piz0.onrender.com https://www.google-analytics.com https://www.googletagmanager.com https://withpersona.com https://challenges.cloudflare.com https://api.plasmic.app https://*.plasmic.app https://*.sentry.io https://api2.amplitude.com https://*.intercom.io wss://*.intercom.io https://api.stripe.com; img-src 'self' data: blob: https://imagedelivery.net https:; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://studio.plasmic.app https://*.plasmic.app; font-src 'self' data: https://fonts.gstatic.com; base-uri 'self' https://studio.plasmic.app https://*.plasmic.app; object-src 'none'; frame-ancestors 'self' https://studio.plasmic.app https://docs.plasmic.app;",
    },
  },
});
