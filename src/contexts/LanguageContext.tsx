...
// Home
'home.hero.title': 'منصتك لبيع وشراء المنتجات الرقمية',
'home.hero.subtitle': 'وسيط موثوق يسهّل عمليات البيع والشراء بأمان وشفافية تامة.',
'home.hero.browseAccounts': 'استعرض المنتجات',
...
'home.step1.title': 'اختَر المنتج المناسب لك',
'home.step1.desc': 'تصفح مئات المنتجات الرقمية المصنّفة حسب اللعبة والسعر والمستوى.',

'home.step2.title': 'ادفع بكل أمان',
'home.step2.desc': 'عمليات الدفع تتم عبر Tap بنظام مشفر ومضمون.',

'home.step3.title': 'استلم منتجك فورًا',
'home.step3.desc': 'بعد الدفع، يتم تسليم المنتج الرقمي تلقائيًا مع ضمان الحقوق للطرفين.',

'home.cta.title': 'ابدأ الآن بثقة',
'home.cta.subtitle': 'انضم لمجتمع اللاعبين اللي يتداولون منتجاتهم الرقمية بأمان عبر NXOLand.',
...
'landing.discord.bulletSafety': 'نصائح التداول وإرشادات أمان المنتجات الرقمية',
...
'sell.subtitle': 'حدد اللعبة التي ترغب في بيع منتجاتها الرقمية',
...
'sell.gaming.title': 'منتجات الألعاب الرقمية',
'sell.gaming.description': 'اعرض منتجاتك الرقمية للبيع بسهولة',
...
'sell.social.accountDescription': 'تفاصيل المنتج الرقمي',
...
'listing.accountImages': 'صور المنتج الرقمي',
'listing.accountImagesDesc': 'قم بتحميل لقطات شاشة من منتجك الرقمي — يمكنك رفع حتى 8 صور.',
...
'listing.accountCredentialsRequired': 'أدخل البريد الإلكتروني وكلمة المرور الخاصة بالمنتج الرقمي.',
'listing.billImagesInstructions': 'قم برفع لقطات من فواتير الشراء — ستُعرض للمشتري بعد الدفع.',
'listing.billImagesSecurityNote': 'معلومات المنتج الرقمي ستكون محمية ومشفرة. سيتم عرضها للمشتري فقط بعد إتمام عملية الدفع.',
...
'listing.deliveryDescriptionHint': 'اشرح للمشتري كيفية تسليم المنتج الرقمي. سيتم عرض هذا الوصف للمشتري بعد إتمام الدفع.',
'listing.termsAcceptance': 'بإدراج هذا المنتج الرقمي، أنت توافق على شروطنا وأحكامنا وسياسة الخصوصية.',
...
'sell.wos.pageSubtitle': 'أضف تفاصيل المنتج الرقمي وابدأ البيع',
'sell.wos.kycRequired': 'التحقق من الهوية (KYC) مطلوب',
'sell.wos.kycDescription1': 'يجب إكمال عملية التحقق من الهوية قبل أن تتمكن من عرض منتجات رقمية للبيع على المنصة.',
...
'sell.wos.accountDetails': 'تفاصيل المنتج الرقمي (إلزامية)',
...
'sell.wos.yes': 'نعم',
'sell.wos.no': 'لا',
'sell.wos.accountDetailsSection': 'تفاصيل المنتج الرقمي',
...
// Sell KingShot
'sell.kingshot.pageTitle': 'إضافة منتج كينج شوت الرقمي للبيع',
'sell.kingshot.pageSubtitle': 'أضف تفاصيل المنتج الرقمي وابدأ البيع',
...
'search.fullPlaceholder': 'ابحث عن المنتجات الرقمية، الأعضاء، أو المواضيع...',
...
// Auth
'auth.tagline': 'منصة الوساطة الآمنة لبيع وشراء المنتجات الرقمية.',
'auth.login': 'تسجيل الدخول',
'auth.loginWithDiscord': 'تسجيل الدخول عبر Discord',
'auth.registerWithDiscord': 'إنشاء حساب عبر Discord',
'auth.discordRequired': 'ربط Discord مطلوب',
'auth.discordRequiredDescription': 'لضمان إدارة أفضل للنزاعات والتواصل، يجب ربط جميع الحسابات الجديدة بـ Discord. يساعدنا هذا في تقديم دعم أفضل وحل المشكلات بسرعة.',
'auth.discordBenefit1': 'حل سريع للنزاعات عبر Discord',
'auth.discordBenefit2': 'تواصل مباشر مع فريق الدعم',
'auth.discordBenefit3': 'إشعارات فورية للطلبات والتحديثات',
...
'auth.pageDescription': 'سجل دخولك أو أنشئ حسابًا جديدًا لبدء تداول المنتجات الرقمية بأمان.',
...
'marketplace.subtitle': 'استعرض جميع المنتجات الرقمية المتاحة للبيع',
'marketplace.description': 'تصفح واشترِ منتجات الألعاب الرقمية أو التواصل الاجتماعي بأمان عبر NXOLand.',
'marketplace.skipToMarket': 'الانتقال إلى المتجر',
'marketplace.searchPlaceholder': 'ابحث عن منتج رقمي...',
...
'marketplace.highToLow': 'من الأعلى للأدنى',
'marketplace.lowToHigh': 'من الأدنى للأعلى',
...
'marketplace.accounts': 'المنتجات الرقمية',
...
'marketplace.games.subtitle': 'تصفح المنتجات الرقمية حسب اللعبة',
'marketplace.games.description': 'اختر لعبة لتصفح المنتجات الرقمية المتاحة',
'marketplace.backToGames': 'العودة إلى الألعاب',
'marketplace.gameNotFound': 'اللعبة غير موجودة',
'marketplace.gameCategorySubtitle': 'تصفح جميع المنتجات الرقمية المتاحة لهذه اللعبة',
'marketplace.noListingsForGame': 'لا توجد منتجات رقمية متاحة لهذه اللعبة حالياً',
...
'marketplace.noListingsDesc': 'لم يتم العثور على منتجات رقمية مطابقة لبحثك.',
...
// Product Details
'product.details': 'تفاصيل المنتج الرقمي',
'product.price': 'السعر',
...
'product.features.instantDelivery': 'تسليم فوري',
'product.features.digitalAccess': 'وصول رقمي',
'product.features.escrowProtection': 'حماية الضمان',
'product.features.securePayment': 'دفع آمن',
'product.features.verifiedAccount': 'حساب موثق',
...
'checkout.paymentSuccess': 'تم الدفع بنجاح!',
'checkout.paymentPending': 'جاري معالجة الدفع...',
...
'order.accountDetails': 'تفاصيل المنتج الرقمي',
...
'myListings.subtitle': 'إدارة جميع منتجاتك الرقمية المعروضة للبيع.',
'myListings.loginRequired': 'يجب تسجيل الدخول لعرض إعلاناتك.',
'myListings.loginButton': 'تسجيل الدخول',
'myListings.addAccount': 'إضافة منتج رقمي جديد',
...
'myListings.emptyStateMessage': 'ابدأ بإضافة منتجك الرقمي الأول للبيع على المنصة.',
'myListings.addNewAccount': 'إضافة منتج رقمي جديد',
...
'myListings.soldDescription': 'هل تم بيع هذا المنتج الرقمي؟ سيتم تحديث الحالة إلى "مباع" وإخفاؤه من الواجهة العامة.',
...
'help.faq1Q': 'كيف أشتري منتجًا رقميًا؟',
'help.faq1A': 'تصفح المتجر، اختر المنتج الرقمي المناسب، ثم اضغط "شراء" وأكمل الدفع. يتم تسليم المنتج خلال 12 ساعة.',
...
'help.faq3A': 'بعد الدفع مباشرة، يتم تسليم المنتج الرقمي تلقائيًا، وتتاح لك 12 ساعة لمراجعته وتأكيد الاستلام.',
'help.faq4Q': 'ماذا أفعل إذا كان المنتج الرقمي غير مطابق للوصف؟',
...
'about.description': 'تعرّف على NXOLand ورؤيتنا لتقديم منصة آمنة لتداول المنتجات الرقمية.',
...
'about.vision': 'رؤيتنا',
'about.visionText': 'نسعى لأن نكون المنصّة الأولى والأكثر ثقة في الشرق الأوسط لتداول المنتجات الرقمية، مع توفير بيئة آمنة وموثوقة للبائعين والمشترين.',
...
'about.story': 'قصّتنا',
'about.storyPara1': 'بدأت NXOLand بفكرة بسيطة: منصّة آمنة وموثوقة لتداول منتجات الألعاب الرقمية في الشرق الأوسط، تضمن حقوق البائع والمشتري معًا.',
'about.storyPara2': 'ومع نمو عالم الألعاب والمنصّات الرقمية، صار تداول المنتجات الرقمية جزءًا من تجربة اللاعب، لكن كثيرًا من المنصّات تفتقر للحماية والدعم الكافيين.',
...
'about.buyerStep1Title': 'تصفّح المنتجات الرقمية',
'about.buyerStep1Desc': 'ابحث عن المنتج الرقمي المناسب من المتجر وحدّد تفضيلاتك.',
...
'about.buyerStep3Desc': 'تستلم بيانات المنتج الرقمي مباشرة بعد موافقة البائع.',
'about.buyerStep4Title': 'التأكيد',
'about.buyerStep4Desc': 'راجع المنتج الرقمي ثم أكّد الاستلام لإكمال الصفقة.',
'about.sellerSteps': 'خطوات البائع',
'about.sellerStep1Title': 'إنشاء إعلان',
'about.sellerStep1Desc': 'أضف تفاصيل المنتج الرقمي والسعر المقترح.',
'about.sellerStep2Title': 'استقبال الطلبات',
'about.sellerStep2Desc': 'تصلُك الطلبات وتراجع التفاصيل قبل التسليم.',
'about.sellerStep3Title': 'تسليم المنتج الرقمي',
'about.sellerStep3Desc': 'أرسل بيانات المنتج الرقمي عبر المنصّة بشكل آمن.',
...
'maintenance.descriptionDetail': 'NXOLand هي منصة آمنة لشراء وبيع منتجات الألعاب الرقمية مع نظام ضمان متكامل. نحن نعمل حالياً على تحديثات مهمة لتحسين تجربتك.',
...
'home.feature4.desc': 'Sellers receive funds instantly after the buyer confirms digital product delivery.',
...
'home.step1.title': 'Find the Right Product',
...
'home.step3.desc': 'Once your payment is confirmed, digital product details are delivered instantly.',
...
'sell.subtitle': 'Select the game you want to sell digital products for.',
'sell.comingSoon': 'More games coming soon...',
'sell.selectCategory': 'Select Category',
'sell.categorySubtitle': 'Choose the type of digital product you want to sell.',
'sell.explore': 'Explore',
'sell.price': 'Price',
'sell.description': 'Description',

'sell.gaming.title': 'Digital Gaming Products',
'sell.gaming.description': 'Sell your digital gaming products easily and securely.',
...
'listing.accountCredentialsRequired': 'Please provide the digital product email and password.',
'listing.billImagesInstructions': 'Upload purchase receipts — visible to the buyer after payment confirmation.',
'listing.billImagesSecurityNote': 'Digital product information is protected and encrypted. It will be visible to the buyer only after payment is completed.',
...
'listing.deliveryDescriptionHint': 'Explain to the buyer how to deliver the digital product. This description will be visible to the buyer after payment is complete.',
'listing.termsAcceptance': 'By listing this digital product, you agree to our Terms, Conditions, and Privacy Policy.',
...
'sell.wos.pageSubtitle': 'Add digital product details and start selling',
'sell.wos.kycRequired': 'Identity Verification (KYC) Required',
'sell.wos.kycDescription1': 'You must complete identity verification before you can list digital products for sale on the platform.',
...
'sell.wos.listingTitlePlaceholder': 'Example: Strong Digital Product - Level 45',
...
'sell.wos.accountDetails': 'Digital Product Details (Required)',
...
'sell.wos.yes': 'Yes',
'sell.wos.no': 'No',
'sell.wos.accountDetailsSection': 'Digital Product Details',
...
// Sell KingShot
'sell.kingshot.pageTitle': 'Add KingShot Digital Product for Sale',
'sell.kingshot.pageSubtitle': 'Add digital product details and start selling',
...
'search.fullPlaceholder': 'Search for digital products, members, or topics...',
...
// Auth
'auth.tagline': 'Secure marketplace for buying and selling digital products.',
'auth.login': 'Log In',
'auth.loginWithDiscord': 'Login with Discord',
'auth.registerWithDiscord': 'Register with Discord',
'auth.discordRequired': 'Discord Connection Required',
'auth.discordRequiredDescription': 'To ensure better dispute management and communication, all new accounts must be connected to Discord. This helps us provide better support and resolve issues quickly.',
'auth.discordBenefit1': 'Quick dispute resolution via Discord',
'auth.discordBenefit2': 'Direct communication with support team',
'auth.discordBenefit3': 'Instant notifications for orders and updates',
...
'marketplace.highToLow': 'From Highest to Lowest',
'marketplace.lowToHigh': 'From Lowest to Highest',
...
'marketplace.accounts': 'digital products',
...
'marketplace.games.subtitle': 'Browse digital products by game',
'marketplace.games.description': 'Select a game to browse available digital products',
'marketplace.backToGames': 'Back to Games',
'marketplace.gameNotFound': 'Game not found',
'marketplace.gameCategorySubtitle': 'Browse all available digital products for this game',
'marketplace.noListingsForGame': 'No digital products available for this game at the moment',
...
// Product Details
'product.details': 'Digital Product Details',
'product.price': 'Price',
'product.level': 'Level',
...
'product.features.instantDelivery': 'Instant Delivery',
'product.features.digitalAccess': 'Digital Access',
'product.features.escrowProtection': 'Escrow Protection',
'product.features.securePayment': 'Secure Payment',
'product.features.verifiedAccount': 'Verified Account',
...
'checkout.useFormAbove': 'Please use the payment form above to complete your payment.',
...
'hyperpayPayment.paymentFailed': 'Payment failed',
'hyperpayPayment.viewOrder': 'View Order',
'hyperpayPayment.viewAllOrders': 'View All Orders',
'hyperpayPayment.paymentSuccess': 'Payment successful!',
'hyperpayPayment.paymentPending': 'Payment is being processed...',
'hyperpayPayment.invalidOrder': 'Invalid order ID.',
'hyperpayPayment.invalidCallback': 'Invalid payment callback.',
'hyperpayPayment.verifying': 'Verifying payment...',
'hyperpayPayment.failedToVerify': 'Failed to verify payment status.',
'hyperpayPayment.title': 'Complete Your Payment',
'hyperpayPayment.description': 'Secure payment powered by HyperPay',
'hyperpayPayment.paymentStatus': 'Payment Status',
'hyperpayPayment.paymentStatusDescription': 'Payment processing status',
...
'orders.timeRemainingToCheck': 'Time remaining to check digital product and confirm receipt',
...
'order.paymentFailedDescription': 'لم يتم معالجة الدفع. يرجى المحاولة مرة أخرى أو استخدام طريقة دفع أخرى.',
'order.paymentFailed': 'Payment Failed',
'order.paymentFailedDescription': 'Your payment could not be processed. Please try again or use a different payment method.',
...
'order.accountDetails': 'Digital Product Details',
...
'myListings.emptyStateMessage': 'Start by adding your first digital product for sale.',
...
'about.storyPara1': 'NXOLand began with a simple idea: a secure, reliable platform for digital gaming product trading in the Middle East, protecting both buyer and seller.',
...
'about.sellerStep1Desc': 'Add your digital product details and price.',
...
'maintenance.descriptionDetail': 'NXOLand is a secure platform for buying and selling digital gaming products with an integrated guarantee system. We are currently working on important updates to improve your experience.',
