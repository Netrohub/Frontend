...
'home.hero.subtitle': 'خدمة وساطة آمنة لتسهيل بيع وشراء المنتجات الرقمية بكل ثقة.',
...
'home.footer.suggestions': 'الاقتراحات والتقييم',
    ...
    'profile.requiresKYC': 'يتطلب توثيق KYC',
    ...
    'profile.totalSales': 'عدد المبيعات',
    'profile.totalPurchases': 'عدد المشتريات',
    ...
    'profile.manageListings': 'إدارة حساباتي المعروضة',
    'profile.accountActions': 'إجراءات الحساب',
    'profile.viewWallet': 'عرض المحفظة →',
    'profile.startVerification': 'بدء التوثيق',
    'profile.viewMyListings': 'عرض قوائمي',
    ...
    'editProfile.avatarUpdateError': 'فشل تحديث الصورة الشخصية',
    'editProfile.avatarPreview': 'معاينة الصورة الشخصية',
    'editProfile.selectImage': 'اختر صورة',
    'editProfile.upload': 'رفع',
    'editProfile.uploading': 'جاري الرفع...',
    'editProfile.invalidImageType': 'يرجى اختيار ملف صورة صحيح',
    'editProfile.imageTooLarge': 'الصورة كبيرة جداً (الحد الأقصى 5 ميجابايت)',
    'editProfile.avatarHint': 'JPG, PNG أو GIF (الحد الأقصى 5 ميجابايت)',
    ...
    'security.logoutOtherDevices': '• سيتم تسجيل الخروج تلقائياً من جميع الأجهزة الأخرى',
    'security.needRelogin': '• ستحتاج إلى تسجيل الدخول مرة أخرى على تلك الأجهزة',
    ...
    'security.twoFactorComingSoon': 'المصادقة الثنائية (قريباً)',
    'security.twoFactorDesc': 'حماية إضافية لحسابك',
    'security.privacyComingSoon': 'الخصوصية (قريباً)',
    'security.privacyDesc': 'إدارة إعدادات الخصوصية',
    ...
    'security.activeSessionsComingSoon': 'الجلسات النشطة (قريباً)',
    'security.manageDevices': 'إدارة الأجهزة المتصلة',
    ...
    'notifications.orderType': 'الطلبات',
    'notifications.disputeType': 'النزاعات',
    'notifications.messageType': 'الرسائل',
    'notifications.systemType': 'النظام',
    'notifications.noNotificationsTitle': 'لا توجد إشعارات',
    ...
    'suggestions.pageSubtitle': 'شارك أفكارك وقيّم تجربتك على المنصة',
    'suggestions.shareIdeas': 'شاركنا أفكارك لإضافة ميزات جديدة',
    'suggestions.noSuggestionsInCategory': 'لا توجد اقتراحات في هذه الفئة',
...
'home.footer.suggestions': 'suggestions',
    ...
    'profile.noRecentActivity': 'No recent activities',
    ...
    'profile.manageListings': 'Manage my listed accounts',
    ...
    'editProfile.imageTooLarge': 'Image is too large (max 5MB)',
    'editProfile.avatarHint': 'JPG, PNG or GIF (max 5MB)',
    ...
    'security.logoutOtherDevices': '• You will be automatically logged out of all other devices',
    'security.needRelogin': '• You will need to log in again on those devices',
    'security.emailNotification': '• A notification of the change will be sent to your email',
    ...
    'security.twoFactorDesc': 'Additional protection for your account',
    'security.privacyComingSoon': 'Privacy (Coming Soon)',
    'security.privacyDesc': 'Manage privacy settings',
    ...
    'suggestions.shareIdeas': 'Share your ideas to add new features',
