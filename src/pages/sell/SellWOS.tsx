...
const stoveImages = {
  1: getStaticImageUrl('STOVE_LV_1', 'public') || stoveLv1,
  2: getStaticImageUrl('STOVE_LV_2', 'public') || stoveLv2,
  3: getStaticImageUrl('STOVE_LV_3', 'public') || stoveLv3,
  4: getStaticImageUrl('STOVE_LV_4', 'public') || stoveLv4,
  5: getStaticImageUrl('STOVE_LV_5', 'public') || stoveLv5,
  6: getStaticImageUrl('STOVE_LV_6', 'public') || stoveLv6,
  7: getStaticImageUrl('STOVE_LV_7', 'public') || stoveLv7,
  8: getStaticImageUrl('STOVE_LV_8', 'public') || stoveLv8,
  9: getStaticImageUrl('STOVE_LV_9', 'public') || stoveLv9,
  10: getStaticImageUrl('STOVE_LV_10', 'public') || stoveLv10,
};
