...
import { Snowflake, Plus, Edit, Trash2, Eye, Shield } from "lucide-react";
    ...
    <div className="min-h-screen relative overflow-hidden" dir="rtl">
      ...
      <nav className="relative z-20 flex items-center justify-between px-6 py-4 md:px-12 border-b border-white/10 backdrop-blur-md bg-[hsl(200,70%,15%,0.5)]">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-medium text-white/80">
          ...
          <Link to="/my-listings" className="text-[hsl(195,80%,70%)]">قائمتي</Link>
          <Link to="/sell" className="hover:text-[hsl(195,80%,70%)] transition-colors">إضافة حساب</Link>
        </div>
      </nav>
